const config = {
  ...
  "header": {
    ...
    "subheadline": "They Secured An Original 4-Bedroom Bungalow in a Mature Neighborhood - Without Overpaying"
  },
  "mainBox": {
    "summary": {
      "title": "How First-Time Buyers Got Their Dream Home After Losing In 3 Bidding Wars in One Of Ottawa's Most Competitive Market Segments",
      ...
      "paragraphs": [
        ...
        "Through professional service and market expertise, we got our clients what they wanted, which was their dream bungalow below a million dollars. They didn't want to overpay; they didn't want bidding wars."
      ]
    },
    "sidebar": {
  ...
  "sections": [
    {
      ...
      "title": "The Challenge",
      "paragraphs": [
        "They'd already lost three homes in multiple offers, each rejection chipping away at their confidence and making them wonder if homeownership was even possible.",
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "Speed as strategy - when the property they eventually purchased hit the market, we acted the same day, not next week. ",
